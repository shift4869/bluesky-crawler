...
class TestBase(unittest.TestCase):
    def test_init(self):
        mock_create_engine = self.enterContext(patch("bluesky_crawler.db.base.create_engine"))
        mock_model_base = self.enterContext(patch("bluesky_crawler.db.base.ModelBase"))
