...
class TestFetcher(unittest.TestCase):
    ...
    def test_init(self):
        mock_logger = self.enterContext(patch("blueskycrawler.crawler.fetcher.logger"))
        mock_manager = self.enterContext(patch("blueskycrawler.crawler.fetcher.BlueskyManager"))
        ...
        self.assertEqual(Path("./blueskycrawler/cache/"), instance.cache_path)
